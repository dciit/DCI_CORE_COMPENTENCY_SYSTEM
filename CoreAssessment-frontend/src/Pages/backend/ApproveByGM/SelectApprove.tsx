...
import { getEmployeeByGroup } from "../../../service/employeeList";
...
function SelectApprove() {
  ...
  useEffect(() => {
    ...
    dispatch({
        ...
        payload:{...approveTrackingStep,
          approveTrackingCount:3,
          approveTrackingSection: approveTrackingStep.approveTrackingSection,
          approveTrackingGroup:approveTrackingStep.approveTrackingGroup,
  ...
  const getData = async () => {
    const result = await getEmployeeByGroup(positionData.empcode,approveTrackingStep.approveTrackingGroup);
  ...
  const dashBoard = (
    ...
    dispatch({
        ...
        payload:{...approveTrackingStep,approveTrackingEmpcode:empcode} 
      
       })

    navigate(`/CASAPP/backend/core-assessmentListApprove-gm/${approveTrackingStep.approveTrackingDept}/${approveTrackingStep.approveTrackingSection}/${approveTrackingStep.approveTrackingGroup}/viewAssessment`);
